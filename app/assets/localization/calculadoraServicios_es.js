...
const calculadoraServicios_es = {
    ...
    mainTitle: "Calculadora de Precios para Servicios",
    summary: "Precios por hora",
    subtitle: "Define tu tarifa por hora basada en tus metas y costos (USD$)",
    languageToggle: { es: "ES", en: "EN" },
    inputsTitle: "Define tus Metas y Costos Mensuales",
    inputs: {
        ...
        includeCSS: "Incluir cálculo de aporte por IVM (Salud - Panamá)",
        includeSalud: "Incluir afiliación a Seguro Social (Salud - Panamá)",
    },
    calculateButton: "Calcular",
    resultsTitle: "Resultados Detallados Mensuales",
    results: {
        sectionTitleCosts: "Costos Operativos (Mensual)",
        salaryAsCostExplanation: "Tu salario es el costo más importante. El negocio debe poder pagártelo y además ser rentable.",
        sectionTitleNoTax: "Ingresos Requeridos (sin Impuesto)",
        sectionSubtitleNoTax: "para cubrir costos y tener un margen de ganancia",
        sectionTitleWithTax: "Total de Ventas Requerido (con Impuesto)",
        sectionSubtitleWithTax: "para alcanzar los ingresos requeridos",
        sectionTitleCSS: "Estimación de Seguro Social (Mensual)",
        sectionSubtitleCSS: "aplicado a tu salario",
        ...
        preTaxRevenue: { label: "Ingresos Requeridos (sin Impuesto)", formula: "Costos Operativos / (1 - % Margen)" },
        ...
        totalBilling: { label: "Total de Ventas", formula: "Ingresos Requeridos + Monto de Impuesto" },
        pricePerHourWithTax: { label: "Precio por Hora (con Impuesto)", formula: "Ingresos Totales / Horas Facturables" },
        ...
        cssBaseIncome: { label: "Ingreso Base para IVM (52%)", formula: "(Salario + Ganancia Neta) * 52%" },
        cssPayment: { label: "Cuota Mensual a Pagar (IVM)", subLabel: "Aporte obligatorio para jubilación", formula: "Ingreso Base * 9.36%" },
        
        saludBaseIncome: { label: "Ingreso Base para CSS (Salud)", formula: "Salario + Ganancia Neta (mínimo $800)" },
