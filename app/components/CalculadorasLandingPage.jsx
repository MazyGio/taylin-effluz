        ...
        <div>
            ...
            <div className="relative sm:h-[34rem] lg:h-[40rem] bg-lightGray2">
                <div className="sm:absolute right-0 hidden sm:block h-full">
                    <Image src="/app/assets/effluz-hero-image.jpg" alt="Calculadoras Effluz" className="h-full" sizes="(max-width: 640px)" />
                </div>
                    ...
                    <div className="flex flex-4 flex-col p-4 gap-y-8">
                        <div id="logo-container" className="flex-row flex-3 pt-2">
                            <div className="flex justify-start max-h-[6rem] sm:justify-normal sm:max-h-[8rem]">
                                <Image src="/app/assets/logo-effluz.png" alt="Effluz Logo" className="max-w-[6rem] sm:max-w-[8rem]" sizes="(max-width: 160px) 4rem, 6rem" />
                                <Image src="/app/assets/sello-taylin.png" alt="Taylin Logo" className="max-w-[6rem] sm:max-w-[8rem]" sizes="(max-width: 160px) 4rem, 6rem" />
                            </div>
                        </div>
